...
def function6():
    ...
    arr = np.zeros((1,11),dtype=int)#wrtie your code here
    arr[0,5]=10
    arr[0,8]=20
    return arr
...
def function8():
    ...
    #write your code here
    x =  np.arange(1,13).reshape((2,6)) #write your code here
    x[:]=6
    return x
...
def function14():
    ...
    arr = np.arange(10, 34, 1).reshape(2,12)#write reshape code
    ans = np.hsplit(arr,4)#write your code here 
...
def function19():
    ...
    W = X.view().transpose()  # Write your code here 
